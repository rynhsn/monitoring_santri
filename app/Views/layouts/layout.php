...
<script>
    ...
    //buat agar checkeditor ditampilkan realtime di kolom sebelahnya
    ClassicEditor.create(document.querySelector('#kt_docs_ckeditor_visi'))
        .then(editor => {
            // console.log(editor);
            editor.model.document.on('change:data', () => {
                document.querySelector('#preview_visi').innerHTML = editor.getData();
            });
        })
        .catch(error => {
            console.error(error);
        });
    ClassicEditor.create(document.querySelector('#kt_docs_ckeditor_misi'))
        .then(editor => {
            // console.log(editor);
            editor.model.document.on('change:data', () => {
                document.querySelector('#preview_misi').innerHTML = editor.getData();
            });
        })
        .catch(error => {
            console.error(error);
        });
    ClassicEditor.create(document.querySelector('#kt_docs_ckeditor_sejarah'))
        .then(editor => {
            // console.log(editor);
            editor.model.document.on('change:data', () => {
                document.querySelector('#preview_sejarah').innerHTML = editor.getData();
            });
        })
        .catch(error => {
            console.error(error);
