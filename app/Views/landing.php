        ...
        <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(<?= base_url() ?>media/svg/illustrations/landing.svg)">
                ...
                <div class="container">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-equal">
                            ...
                            <!--begin::Logo image-->
                            <a href="<?= base_url() ?>">
                                <img alt="Logo" src="<?= base_url() ?>media/logos/logo.png" class="logo-default h-25px h-lg-40px" />
                                <img alt="Logo" src="<?= base_url() ?>media/logos/logo.png" class="logo-sticky h-20px h-lg-25px" />
                            </a>
                            <!--end::Logo image-->
                        </div>
                        <!--end::Logo-->
                        ...
                        <div class="d-lg-block" id="kt_header_nav_wrapper">
                            <div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav_wrapper'}">
                                ...
                                <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-semibold" id="kt_landing_menu">
                                    ...
                                    <div class="menu-item">
                                        <!--begin::Menu link-->
                                        <a class="menu-link nav-link active py-3 px-4 px-xxl-6" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Dashboard</a>
                                        <!--end::Menu link-->
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
            ...
            <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                ...
                <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                    <!--begin::Title-->
                    <h1 class="text-white lh-base fw-bold fs-2x fs-lg-3x mb-15">Portal Monitoring Santri
                        <br />
                        <span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
								<span id="kt_landing_hero_text">PONDOK PESANTREN AL-ISLAM</span>
							</span></h1>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
    ...
    <div class="mb-n10 mb-lg-n20 z-index-2">
        ...
        <div class="container">
            ...
            <div class="text-center mb-17">
                <!--begin::Title-->
                <h3 class="fs-2hx text-dark mb-5" id="info" data-kt-scroll-offset="{default: 100, lg: 150}">Tentang Sekolah</h3>
                <!--end::Title-->
                <!--begin::Text-->
                <div class="fs-5 text-muted fw-bold"><?= $lembaga['sejarah'] ?></div>
                <!--end::Text-->
            </div>
            <!--end::Heading-->
            <!--begin::Row-->
