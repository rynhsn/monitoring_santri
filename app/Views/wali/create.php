        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Label-->
                    <label class="col-lg col-form-label required fw-semibold fs-6">Alamat Lengkap</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-5 fv-row">
                        <textarea name="alamat"
                               class="form-control form-control-lg form-control-solid <?= validation_show_error('alamat') ? 'is-invalid' : ''; ?>"
                               placeholder="Alamat lengkap wali santri"><?= old('alamat') ?></textarea>
                        <div class="invalid-feedback">
