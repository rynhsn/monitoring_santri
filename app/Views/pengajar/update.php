...
<!--                               placeholder="Jabatan"-->
<!--                               value="--><?php //= old('jabatan') ?? $pengajar['jabatan'] ?><!--" required/>-->
<!--                        <div class="invalid-feedback">-->
...
<!--                        </div>-->
                        <select class="form-select form-select-solid <?= validation_show_error('jabatan') ? 'is-invalid' : ''; ?>" data-control="select2"
                            ...
                            <option></option>
                            <option value="Pengajar Bahasa" <?= $pengajar['jabatan'] == 'Pengajar Bahasa' ? 'selected' : ''  ?>>Pengajar Bahasa</option>
                            <option value="Pengajar Tahfidz" <?= $pengajar['jabatan'] == 'Pengajar Tahfidz' ? 'selected' : ''  ?>>Pengajar Tahfidz</option>
                        </select>
                        <div class="invalid-feedback">
